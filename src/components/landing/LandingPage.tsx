...
export function LandingPage() {
  return (
    <div className="landing-page min-h-screen bg-[#0a0a0a] text-white">
      {/* Hero */}
      <header className="relative overflow-hidden pb-8 pt-[max(0,env(safe-area-inset-top))] sm:pb-12">
        <div
        ...
        <div className="relative px-5 pt-5 sm:px-8 sm:pt-8">
          <div className="mx-auto grid max-w-6xl items-start gap-6 md:grid-cols-2 md:gap-10 lg:gap-14">
            <div className="text-center md:text-left">
              ...
              <h1 className="mt-4 text-[1.75rem] font-bold leading-[1.1] tracking-tight sm:text-5xl">
                Finance news, built for the way{" "}
                <span className="bg-gradient-to-r from-[#3B6EF5] to-[#00C6C6] bg-clip-text text-transparent">
                  you scroll.
                </span>
              </h1>
              <p className="mx-auto mt-3 max-w-lg text-[14px] leading-snug text-[#9ca3af] sm:text-base sm:leading-relaxed md:mx-0">
                Pocket Finance turns breaking market headlines into a fast,
                swipeable experience — read the story, check the stock, and
                move on in seconds.
              </p>
              <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:gap-3 md:justify-start">
                <Link
                  href={APP_BASE}
              ...
              <div className="mt-4 grid grid-cols-2 gap-1.5 sm:flex sm:flex-wrap sm:gap-2 md:justify-start">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="mt-4 flex w-full max-w-[240px] justify-between gap-2 md:max-w-[260px]">
      ...
      <section className="border-t border-white/[0.06] px-5 py-10 sm:px-8 sm:py-12">
      ...
      <section
        id="waitlist"
        className="relative border-t border-white/[0.06] px-5 py-12 sm:px-8 sm:py-16"
      >
        <div
          className="pointer-events-none absolute inset-0"
          style={{
          ...
          aria-hidden
        />
        <div className="relative mx-auto max-w-lg rounded-2xl border border-white/[0.08] bg-[#111]/60 p-6 backdrop-blur-sm sm:p-8">
          <div className="flex flex-col items-center text-center">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-[#00C6C6]/15">
