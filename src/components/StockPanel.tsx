        ...
        <nav className="mt-4 flex gap-5 border-b border-white/[0.08]">
          {TABS.map((tab) => (
            ...
            >
              {tab}
              {activeTab === tab && (
                <span className="absolute bottom-0 left-0 right-0 h-0.5 rounded-full bg-pocket-teal" />
              )}
            </button>
          ))}
        </nav>
        ...
        {activeTab === "Overview" ? (
          <>
            ...
            <a
              ...
              data-no-drag
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-white py-3.5 text-sm font-bold text-black active:scale-[0.98]"
              style={{ touchAction: "manipulation" }}
            >
              Trade this stock
            ...
            <div className="mt-6 grid grid-cols-2 gap-x-4 gap-y-5 border-t border-white/[0.08] pt-6">
            ...
            <div className="mt-8">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-pocket-blue">
                  View all
                </span>
              </div>
