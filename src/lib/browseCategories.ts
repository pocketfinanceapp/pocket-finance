...
export const BROWSE_CATEGORY_KEYWORDS: Record<BrowseCategory, string[]> = {
  ...
  Economy: ["economy", "gdp", "inflation", "recession", "unemployment", "jobs"],
  ...
  "Real Estate": ["property", "housing", "real estate", "mortgage", "reit"],
  Banking: ["bank", "finance", "lending", "fed", "interest rate", "credit"],
  Commodities: ["gold", "silver", "commodities", "copper", "wheat", "corn"],
  "World Markets": [
    "international",
    "global",
    "europe",
